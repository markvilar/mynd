...
SOURCE_FILE="r7jjskxq_without_metadata.psz"
DESTINATION_FILE="r7jjskxq_with_metadata.psz"
...
poetry run mynd ingest-metadata \
  ...
  --bundle \
    ...
    "${METADATA_DIR}/r7jjskxq_20101023_210332_cameras_metadata.csv" \
    "${CONFIG}" \
  --bundle \
    "r7jjskxq_20121013_060425" \
    "${METADATA_DIR}/r7jjskxq_20121013_060425_cameras_metadata.csv" \
    "${CONFIG}" \
  --bundle \
    "r7jjskxq_20131022_004934" \
    "${METADATA_DIR}/r7jjskxq_20131022_004934_cameras_metadata.csv" \
    "${CONFIG}"
