...
def _read_config_json(path: Path, mode: str = "r") -> Result[dict, str]:
...
def _read_config_yaml(path: Path, mode: str = "r") -> Result[dict, str]:
...
def _read_config_toml(path: Path, mode: str = "r") -> Result[dict, str]:
...
def _read_config_msgpack(path: Path, mode: str = "r") -> Result[dict, str]:
